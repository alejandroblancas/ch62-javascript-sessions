...
// Permiteb interpolacion ${} y saltos de linea. Mas limpio que concatenar con '+'.
// ejemplo: `Hola ch62, soy ${firstName}`

console.log(`My name is ${firstName} \nand I am ${age} years old, my gender is ${gender}.`);

/* =========================================================================
3. Datos primitivos: Number y bigint
============================================================================
JavaScript tiene un solo tipo de enteros y decimales: 'number'.
Number: tipo de dato numerico de 64 bits para representar valores enteros, punto flotante,
...
/* Tipos de datos: 100, 1, 0.258
-numeros positivos:
-numeros negativos:
-valores que no pueden ser representados numericamente: NaN
-numeros infinitosL +Infinity, -Infinity
*/
console.log(typeof 3.121592); //number
console.log(typeof (3*3)); //number
console.log(typeof ""); //string
console.log(typeof " "); //string
console.log(typeof (3*"pitufo trabajor")); //number
console.log(typeof (NaN)); //number
console.log(typeof +Infinity); //number
console.log(typeof (3 + "Viernes tematico")); //string
console.log(typeof "3Viernestematico"); //string
